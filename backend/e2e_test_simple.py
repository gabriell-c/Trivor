"""Run E2E test and save to file."""
import sys, urllib.request, urllib.parse, json, os

sys.path.insert(0, '.')

ALL_KEYS = sys.argv[1] if len(sys.argv) > 1 else ""
OUT = r'C:\Users\xxxsa\OneDrive\Área de Trabalho\python\curriculo\backend\result_e2e_full2.txt'
