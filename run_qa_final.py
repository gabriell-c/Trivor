...
OUT_PATH = r"c:\Users\xxxsa\OneDrive\Área de Trabalho\python\curriculo\qa_final_results.json"
LOG_PATH = r"c:\Users\xxxsa\OneDrive\Área de Trabalho\python\curriculo\qa_final_log.txt"
...
def run_qa():
    with open(LOG_PATH, 'w', encoding='utf-8') as f:
        f.write("QA Final - " + time.strftime("%Y-%m-%d %H:%M:%S") + "\n")
        f.write("="*60 + "\n\n")
